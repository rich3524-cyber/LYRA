        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span
                  className={cn(
                    ...
                    (isAwaitingMedia && (post.status === 'DRAFT' || post.status === 'APPROVED')) || isApprovalOverdue
              ...
              {isApprovalOverdue && (
                <p className="font-sans text-xs text-status-warning leading-relaxed">
                  This post has been waiting for approval past its deadline. Adjust the approval deadline in workspace
                  settings.
                </p>
              )}
