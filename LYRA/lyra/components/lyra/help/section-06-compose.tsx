  ...
  return (
    <section id="compose" className="space-y-8 scroll-mt-28">
      ...
      <Subsection title="Writing your caption">
        <p className="font-sans text-sm text-text-secondary leading-relaxed">
          The editor is a plain-text field. It keeps line breaks, but it does not support
          bold/italic formatting, hashtag or @mention highlighting, an emoji picker, or link
          previews — whatever you type is what gets sent to each selected platform.
        </p>
        <p className="font-sans text-sm text-text-secondary leading-relaxed mt-3">
      ...
      <Subsection title="Scheduling a post">
        <Steps>
          ...
          <Step n={2}>
            ...
            not display a timezone — the time you enter is interpreted using the timezone set for
      ...
      <Subsection title="Sending for client approval">
        ...
        <p className="font-sans text-sm text-text-secondary leading-relaxed mt-3">
          LYRA does not send an email when a post is waiting for approval. If the workspace has a
          Slack channel connected with the &ldquo;New post pending approval&rdquo; notification
          turned on, a message posts there when a post enters this status — otherwise the approver
          needs to check LYRA directly to see what&apos;s pending.
        </p>
      </Subsection>
    </section>
  )
