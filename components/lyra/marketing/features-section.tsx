  ...
  return (
    <section id="features" className="py-24 border-t border-background-border px-6">
      <div className="max-w-5xl mx-auto">
        <p className="font-sans text-xs text-text-tertiary uppercase tracking-[0.1em] text-center mb-3">What LYRA does</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {FEATURES.map(({ icon: Icon, title, body }) => (
            <div key={title} className="rounded-xl bg-background-secondary border border-background-border p-6">
              ...
              <h3 className="font-sans text-sm font-medium text-text-primary mb-2">{title}</h3>
